...
<head>
    ...
    <title><fmt:message key="inbox"/> <fmt:message key="private"/> - <fmt:message key="head"/></title>
</head>
        ...
        <table id="information">
            <tr>
                <td class="tableTitle" colspan="2">
                    <fmt:message key="inbox"/> <fmt:message key="private"/> &#8195;
                    <a class="yellowLinks" href="private_out"><fmt:message key="outbox"/></a>
                </td>
            </tr>
                ...
                <tr class="entry_forum">
                    ...
                    <td class="main_entry">
                        ...
                        <form class="delete_button" action="delete_private_message" method="post">
                            ...
                            <input type="hidden" name="activity" value="recipient">
                            <input type="submit" value="X"/>
                        </form>
                        <fmt:message key="from"/> <strong><a href="profile?login=${message.from.login}">
                            ${message.from.login}</a></strong> ${message.dateOfSending}
                    </td>
                </tr>
            </c:forEach>
            <tr>
